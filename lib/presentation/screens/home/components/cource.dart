...
import '../data/get_course.dart'; // ApiService faylini import qilish
import '../../VideoDetail/data/models/course.dart'; // Course modelini import qilish
import '../../VideoDetail/cource_detail.dart'; // Kurs detallari sahifasi

class CourceGrid extends StatefulWidget {
  const CourceGrid({Key? key}) : super(key: key);

  @override
  _CourceGridState createState() => _CourceGridState();
}

class _CourceGridState extends State<CourceGrid> {
