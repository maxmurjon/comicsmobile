...
import '../data/auth_service.dart'; // AuthService importi
import '../widgets/custon_scaffold.dart';
import '../../../provider/course_provider.dart'; // Import the AuthProvider
                          ...
                          onPressed: () async {
                            if (_formSignInKey.currentState!.validate() &&
                              ...
                              try {
                                ...
                                await authProvider.signIn(phoneNumber, password);
                                ...
                                if (authProvider.token != null) {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text('Error: ${authProvider.token}'),
                                    ),
                                  );
                                }
                              } catch (e) {
